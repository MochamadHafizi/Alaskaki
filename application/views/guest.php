...
<br><br>
  <h2 class="text-center font-weight-bolder" style="font-family: times new roman;">PRODUK SEPATU ALASKAKI</h2><br><br>
    <div class="row text-center">

        <?php foreach ($barang as $brg) : ?>

        <div class="card ml-1 m-1" style="width: 16rem;">
            ...
            <div class="card-body">
                ...
                <?php echo anchor('auth/login/'.$brg->id_brg, '<div class="btn btn-sm btn-warning">Beli</div>') ?>
                <?php echo anchor('dashboard/detail_guest/'.$brg->id_brg, '<div class="btn btn-sm btn-primary">Detail</div>') ?>
            </div>
        </div>
        <?php endforeach; ?>
    </div>
