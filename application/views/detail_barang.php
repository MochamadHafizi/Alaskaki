  ...
  <?php foreach ($barang as $brg) : ?>
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <?php echo anchor('dashboard/tambah_ke_keranjang/'.$brg->id_brg, '<div class="btn btn-md btn-warning mr-2">Beli</div>') ?>
            <?php echo anchor('dashboard/index/', '<div class="btn btn-md btn-primary">Kembali</div>') ?>
         </div>
